...
const strings = {
  en: {
    ...
    tgAllowedChatId: "Allowed Chat ID",
    tgAllowedChatIdPlaceholder: "e.g. -1001234567890",
    tgAllowedChatIdHelp: "Only messages from this chat ID will be processed. Leave empty to allow all chats.",
  ...
  "zh-cn": {
    ...
    tgBotToken: "Telegram Bot Token",
    tgAllowedChatId: "允许的聊天 ID",
    tgAllowedChatIdPlaceholder: "例如 -1001234567890",
    tgAllowedChatIdHelp: "仅处理来自此聊天 ID 的消息。留空则允许所有聊天。",
